<template>
  <div class="request-item" :id="'request-' + request.id">
    ...
    <p class="request-description">{{ request.shortDescription }}</p>

    <!-- Third Row: Date -->
    <p class="request-date">Date: {{ formattedDate }}</p>
    ...
    <div class="request-actions">
      ...
      <a :href="request.link" target="_blank" class="link-icon">🔗</a>
    </div>
...
export default {
  ...
  props: {
    request: Object,
    isExpanded: Boolean, // Parent controls the expanded state
  },
  computed: {
    statusClass() {
